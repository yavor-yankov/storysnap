  ...
  async function handleSignup(e: React.FormEvent) {
    ...
    if (error) {
      setError(error.message === "User already registered"
        ? "Вече има акаунт с този имейл. Влезте от тук."
    ...
    return (
      <div className="flex min-h-[calc(100dvh-4rem)] items-center justify-center px-4 py-12">
        <div className="w-full max-w-md text-center">
          ...
          <h1 className="text-2xl font-black text-brand-brown">Проверете имейла си!</h1>
          <p className="mt-3 text-brand-brown-body">
            Изпратихме линк за потвърждение на{" "}
            <strong className="text-brand-brown-sub">{email}</strong>.
            Кликнете на линка и акаунтът ви ще бъде активиран.
          </p>
          <Link href="/" className="mt-6 inline-block text-sm font-bold text-brand-orange hover:underline">
    ...
    <div className="flex min-h-[calc(100dvh-4rem)] items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <h1 className="text-2xl font-black text-brand-brown">Създайте акаунт</h1>
        ...
        <div className="rounded-3xl bg-white p-8 shadow-[0_6px_24px_rgba(17,24,39,0.08)]">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            <div>
              <Label htmlFor="name" className="font-semibold text-brand-brown-sub">
                Вашето име
              </Label>
              <Input
                id="name"
          ...
          <p className="mt-5 text-center text-xs text-brand-brown-body">
